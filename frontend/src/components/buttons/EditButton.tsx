...
function EditButton({selfInfo}: {selfInfo: UserResponse}) {
    ...
    return (<>
            <div onClick={handleShow} className='edit-button cursor-pointer px-[12px] py-2 bg-accentColor hover:accentColorHover rounded-xl flex justify-center items-center gap-2 text-sm font-medium text-secondaryColor '><PencilSimple weight='bold' size={22}></PencilSimple> <div>Edit</div></div>
        ...
        <Modal.Footer className='bg-[#1c212e]'>
          <Button className='bg-[#1c212e]' variant="secondary" onClick={handleClose}>
            Close
          </Button>
          <Button className='bg-[#1c212e]' variant="primary" onClick={() => handleSave(userInfo)}>
            Save Changes
          </Button>
        </Modal.Footer>
      </Modal>
